...
class Bot(commands.Bot):
    def __init__(self):
        super().__init__(token="oauth:0nyov8e54o2d1ezitbcnvcbznrafcy", prefix="!", initial_channels=["katinka4"])
        self.esclient = eventsub.EventSubWSClient(self)


    @commands.command(name="hey")
    async def ohHey(self, ctx: commands.Context):
    ...
    async def heyListRemove(self, ctx: commands.Context, *, text):
